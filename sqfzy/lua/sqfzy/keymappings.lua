...
lvim.builtin.which_key.mappings["W"] = { "<cmd>lua vim.lsp.buf.format()<cr><cmd>w!<cr>", "Save with format" }
...
lvim.builtin.which_key.mappings["S"] = {
  name = "Sqfzy",
  i = { "<cmd>edit $HOME/AppData/Local/lvim/sqfzy/lua/sqfzy/init.lua<cr>", "Sqfzy init.lua" },
  k = { "<cmd>edit $HOME/AppData/Local/lvim/sqfzy/lua/sqfzy/keymappings.lua<cr>", "Sqfzy keymappings.lua" },
  o = { "<cmd>edit $HOME/AppData/Local/lvim/sqfzy/lua/sqfzy/options.lua<cr>", "Sqfzy options.lua" },
  p = { "<cmd>edit $HOME/AppData/Local/lvim/sqfzy/lua/sqfzy/plugins.lua<cr>", "Sqfzy plugins.lua" },
}
lvim.builtin.which_key.mappings["l"]["m"] = { "<cmd>Mason<cr>", "Mason" }
